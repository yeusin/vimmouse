...
class MacWindowManager(WindowManagerProvider):
    ...
    def _get_visible_rect(self) -> Tuple[float, float, float, float]:
        ...
        focused_screen = NSScreen.mainScreen() or screens[0]
    ...
    def tile_window(self, quadrant: int) -> None:
        ...
        hw, hh = ax_w / 2, ax_h / 2
        coords = {1: (ax_x, ax_y), 2: (ax_x + hw, ax_y), 3: (ax_x, ax_y + hh), 4: (ax_x + hw, ax_y + hh)}
